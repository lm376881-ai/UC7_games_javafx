...
public class PlataformaRepository {
    ...
    public void salvar(Plataforma plataforma) {
        ...
        String sql = "INSERT INTO tb_plataformas " +
                "(nome, fabricante, data_lancamento, valor) " +
                "VALUES (?, ?, ?, ?);";

        try {

            PreparedStatement stmt =
                    ConexaoSQLite.getConexao().prepareStatement(sql);
    ...
    public int getTotalPlataformas() {
        ...
        String sql =
                "SELECT COUNT(id) AS total_plataformas FROM tb_plataformas";
